...
<!-- Begin Page Content -->
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 colorTitle">Informazioni Sulle Transizioni Effettuate</h1>
	</div>
  	<div class="row">
	      ...
	      <div class="card border-left-primary shadow h-100 py-2">
	        <div class="card-body">
	          <div class="row no-gutters align-items-center">
	            <div class="col mr-2">
	              <div class="text-lg font-weight-bold text-primary text-uppercase mb-1">num. Transizioni</div>
	    ...
	    <div class="col-xl-3 col-md-6 mb-4">
			<div class="wrap-table100" id="table-wrapper">
				<div class="table100 ver3 m-b-110" style="overflow-x:auto;">
					...
					$sql  = "SELECT Data, Valore FROM transizioni WHERE Username_Utente = '" . $_SESSION['username'] . "' ORDER BY Data DESC;";
					$result = query($sql);
